...
|---------|---------|
|**Learn the Teams Basics**<br>[Download the .zip file](https://github.com/olbosede/TeamsEDUAdoption/blob/master/Learn%20the%20basics.oft)<br> ![Screenshot of Learn the Teams Basics email template.](media/outlook-template-teams-basics.png)   |**Build a custom classroom environment**<br>[Download the .zip file](https://github.com/olbosede/TeamsEDUAdoption/blob/master/Customize%20your%20learning%20environment.oft)<br>![Screenshot of Customize your learning environment template.](media/outlook-template-teams-learn.png)       |
|**Manage your workflow**<br>[Download the .zip file](https://github.com/olbosede/TeamsEDUAdoption/blob/master/Focus%20on%20students.oft)<br>![Screenshot of See how to streamline your workflow template.](media/outlook-template-teams-workflow.png)     |**Personalize learning**<br>[Download the .zip file](https://github.com/olbosede/TeamsEDUAdoption/blob/master/Better%20tools.oft)<br>![Screenshot of Learn how to chat like a pro template.](media/outlook-template-teams-chat.png)        |
|**Work from anywhere**<br>[Download the .zip file](https://github.com/olbosede/TeamsEDUAdoption/blob/master/Home%20in%20homework.oft)<br>![Screenshot of Take Teams on the go template.](media/outlook-template-teams-connect.png)    |          |
